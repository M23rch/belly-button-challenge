...
var barTrace = {
  x: sample_values.slice(0,10).reverse(),                                        // X-axis: top 10 sample values
  y: yticks.slice(0,10).reverse(),                                                 // Y-axis: formatted OTU IDs
  text: otu_labels.slice(0,10).reverse(),                                        // Hover text: top 10 labels
  type: 'bar',                                               // Chart type: horizontal bar
  orientation: 'h'                                           // Horizontal orientation
};

var barLayout = {
  title: 'Top 10 OTUs',                                      // Chart title
